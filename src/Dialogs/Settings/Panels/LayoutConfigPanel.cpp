...
static constexpr StaticEnumChoice info_box_geometry_list[] = {
  ...
  { InfoBoxSettings::Geometry::SPLIT_16,
    N_("16 Split") },
  ...
  { InfoBoxSettings::Geometry::BOTTOM_10_ROW,
    N_("10 Bottom (single row, Landscape)") },
  { InfoBoxSettings::Geometry::IPAD_12,
    N_("12 iPad (1x12 Landscape / 2x6 Portrait)") },
