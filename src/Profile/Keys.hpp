...
constexpr std::string_view SoaringSpotContestURL = "SoaringSpotContestURL";
constexpr std::string_view SoaringSpotContestName = "SoaringSpotContestName";
constexpr std::string_view SoaringSpotClassSlug = "SoaringSpotClassSlug";
constexpr std::string_view SoaringSpotClassName = "SoaringSpotClassName";
constexpr std::string_view SoaringSpotAirspaceURL = "SoaringSpotAirspaceURL";
constexpr std::string_view SoaringSpotWaypointURL = "SoaringSpotWaypointURL";
constexpr std::string_view SoaringSpotTaskURL = "SoaringSpotTaskURL";
...
constexpr std::string_view TrafficTrailEnabled = "TrafficTrailEnabled";
constexpr std::string_view TrafficTrailLength = "TrafficTrailLength";
constexpr std::string_view TrafficTrailWidth = "TrafficTrailWidth";
constexpr std::string_view TrafficTrailFadeEnabled = "TrafficTrailFadeEnabled";
constexpr std::string_view TrafficTrailMemoryLimit = "TrafficTrailMemoryLimit";
constexpr std::string_view TrafficOffscreenMarkerSize = "TrafficOffscreenMarkerSize";
constexpr std::string_view TrafficOffscreenClimbRateDistance = "TrafficOffscreenClimbRateDistance";
