...
Brush TrafficLook::GetBasicTrafficBrush(const TrafficClimbAltIndicators &indicators) const noexcept
{
...
Brush TrafficLook::GetColourfulTrafficBrush(const TrafficClimbAltIndicators &indicators) const noexcept
{
