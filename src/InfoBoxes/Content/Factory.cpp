...
static constexpr MetaData meta_data[] = {
  ...
  // e_GR_Avg_TE
  {
    N_("GR average TE"),
    N_("GR Avg TE"),
    N_("Average total-energy-compensated glide ratio. The smaller value is the required Final GR, and the box turns green when the average glide ratio is above it."),
